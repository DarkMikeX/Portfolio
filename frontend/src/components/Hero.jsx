      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-16 lg:mt-24 grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <div
              key={stat.id}
              className="group p-6 bg-white/5 backdrop-blur-sm border border-white/10 hover:border-red-500/50 rounded-2xl transition-all duration-300 hover:bg-red-500/5"
